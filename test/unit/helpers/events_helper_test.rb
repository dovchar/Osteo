...
class EventsHelperTest < ActionView::TestCase
  ...
  test "time should parse datepair_select tags" do
    model = 'event'
    field = 'starts_at'

    params = { model => { 'starts_at_date' => '2011-12-31', 'starts_at_time' => '01:14:00' } }
    Time.parse_datepair_select(params, model, field)
  ...
  test "time should not parse datepair_select tags" do
    model = 'event'
    field = 'starts_at'
